...
export function Favorites() {
  ...
  useEffect(() => {
    ...
    setFavoriteItems(favoritesFromStorage);
  }, []);
  ...
  function removeFromCart(id) {
    const updatedCartItems = favoriteItems.filter((item) => item.id !== id);
    setFavoriteItems(updatedCartItems);
  }

  function moveToCart(id, favoriteItems, setFavoriteItems) {
    const itemToMove = favoriteItems.find((item) => item.id === id);
    const cartItemsFromStorage = JSON.parse(localStorage.getItem("cart")) || [];
    const updatedCartItems = [...cartItemsFromStorage, itemToMove];
  ...
  return (
    <div className="cartPage">
        ...
        <div className="boxItemCart" key={item.id}>
          ...
          <div className="infoItemCart">
            ...
            <button
              ...
              onClick={() =>
                moveToCart(item.id, favoriteItems, setFavoriteItems)
              }
            >
              Move to Cart
            </button>
      ...
      <Link className="linkToCartFromFavorites" to="/cart">
        Go to cart
      </Link>
    </div>
  );
