...
import { Link } from 'react-router-dom';
 ...
 export function PaymentPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (error) {
      console.error('Errore durante il reindirizzamento al checkout:', error);
    }
  };
  ...
  return (
    <div className='paymentPage'>
      ...
      <h2 className='confirmOrder'>Conferma l'ordine</h2>
      
      <form onSubmit={handleSubmit}>
        <button className='paga' type="submit">Paga con Stripe</button>
      </form>
    </div>
  );
}
