    ...
    <div className="navbar">
      ...
      <div className="utilityBox">
        <div className="favorites">
          <Link to="/favorites">
            <svg
              className="svgFavorites"
              id="Layer_2"
              data-name="Layer 1"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 699.33 590.86"
            >
              <path
                className="cls-1"
                d="M620.64,366.64l-230.9,204.62c-19.18,16.99-48.02,16.99-67.19,0l-230.9-204.62C-139.8,162.05,148.4-138.46,356.14,102.14c180.47-255.66,474.7,61.95,264.5,264.5Z"
              />
            </svg>
          </Link>
        </div>
        <div className="boxCart">
          <Link to="/cart">
            ...
            >
              <path
                className="cls-3"
                d="M686.5,167.04c-4.02-5.26-10.27-8.35-16.88-8.35h-361.1c-11.74,0-21.24,9.51-21.24,21.24s9.5,21.24,21.24,21.24h333.29l-52.13,191.17H177.23L116.93,90.8c-.83-4.11-2.84-7.88-5.81-10.85L47.4,16.22c-8.3-8.3-21.74-8.3-30.04,0-8.3,8.3-8.3,21.74,0,30.04l59.18,59.18,62.46,312.31c1.99,9.93,10.7,17.07,20.83,17.07h446.07c9.58,0,17.96-6.41,20.49-15.65l63.72-233.66c1.74-6.39.42-13.22-3.61-18.48Z"
              />
              <path
                className="cls-3"
                d="M266.03,456.07c-46.86,0-84.97,38.12-84.97,84.97s38.1,84.97,84.97,84.97,84.97-38.12,84.97-84.97-38.11-84.97-84.97-84.97ZM266.03,583.52c-23.42,0-42.48-19.05-42.48-42.48s19.06-42.48,42.48-42.48,42.48,19.05,42.48,42.48-19.06,42.48-42.48,42.48Z"
              />
              <path
                className="cls-3"
                d="M499.69,456.07c-46.86,0-84.97,38.12-84.97,84.97s38.1,84.97,84.97,84.97,84.97-38.12,84.97-84.97-38.11-84.97-84.97-84.97ZM499.69,583.52c-23.42,0-42.48-19.05-42.48-42.48s19.06-42.48,42.48-42.48,42.48,19.05,42.48,42.48-19.06,42.48-42.48,42.48Z"
              />
            </svg>
          </Link>
        </div>
