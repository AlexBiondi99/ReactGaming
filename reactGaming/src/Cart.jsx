                ...
                <div className="boxItemCart" key={item.id}>
                    ...
                    <div className="infoItemCart">
                       ...
                       <div className="quantity">
                        <button className="dec" onClick={() => decreaseQuantity(item.id)}>-</button>
                        <p className="quantityBox">{item.quantity}</p>
                        <button className="inc" onClick={() => increaseQuantity(item.id)}>+</button>
                       </div>
                       <button className="removeToCart" onClick={() => removeFromCart(item.id)}>Remove</button>
                    </div>
                </div>
            ))}
            <div className="totalPrice">{`${totalPrice.toFixed(2)} $`}
